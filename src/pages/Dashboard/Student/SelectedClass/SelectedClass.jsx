...
const SelectedClass = () => {
  ...
  useEffect(() => {
    axios
      .get(`${baseURL}/cart/${currentUser?.email}`)
      .then((res) => {
        setClasses(res.data);
        setLoading(false);
      })
  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`${baseURL}/delete-cart-item/${id}`)
          .then((res) => {
  ...
  return (
    <div>
      <div className="my-6 mt-28 md:mt-5 lg:mt-5">
      ...
      <div className="h-screen py-8">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="lg:w-1/4 w-full lg:sticky lg:top-0">
